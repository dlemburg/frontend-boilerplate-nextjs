import { parseQueryParams, buildSearchQueryParams } from './query-params-util';
...
export const parseActionRouteParams = (locationSearch: string): RouteParams => {
  return getActionRouteParams(parseQueryParams(locationSearch) as RouteParams) || {};
};
...
export const getModalRouteActionValue = (action: string): string => action.replace(getModalActionKey(), '');
