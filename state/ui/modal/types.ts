...
export type ModalComponentProps = {
  ...
  onClose: (e: any, modalCloseMechanism: ModalCloseMechanism) => void;
...
export type OpenModalPayloadWithProps<T> = Omit<OpenModalPayload, 'body'> & { bodyProps: T };
...
export type OpenModalDispatchPayload = OpenModalPayload & { routeWhenModalOpened: string };
